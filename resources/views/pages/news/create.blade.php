...
@section("content")
    <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl">Create New</h2>
        </div>
        <form action="{{route('news.store')}}" method="POST" enctype="multipart/form-data" class="mx-auto mt-16 max-w-xl sm:mt-20">
            @csrf
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    <label for="file" class="block text-sm/6 font-semibold text-gray-900">File</label>
                    <div class="mt-2.5">
                ...
                <div class="sm:col-span-2">
                    <label for="date" class="block text-sm/6 font-semibold text-gray-900">Date</label>
                    <div class="mt-2.5">
                        <input type="date" value="{{old('date_published')}}" name="date_published" id="date_published"
                               class="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600">
                    </div>
                ...
                <div class="sm:col-span-2">
                    <label for="author" class="block text-sm/6 font-semibold text-gray-900">Author</label>
                    <div class="mt-2.5">
